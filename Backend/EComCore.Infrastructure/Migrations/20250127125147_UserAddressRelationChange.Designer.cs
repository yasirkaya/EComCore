...
namespace EComCore.Infrastructure.Migrations
{
    ...
    [Migration("20250127125147_UserAddressRelationChange")]
    partial class UserAddressRelationChange
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EComCore.Domain.Entities.Order", b =>
                {
                    b.HasOne("EComCore.Domain.Entities.Address", "Address")
                        .WithMany()
                        .HasForeignKey("AddressId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EComCore.Domain.Entities.Payment", "Payment")
                        .WithOne()
                        .HasForeignKey("EComCore.Domain.Entities.Order", "PaymentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EComCore.Domain.Entities.Shipment", "Shipment")
                        .WithOne()
                        .HasForeignKey("EComCore.Domain.Entities.Order", "ShipmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
